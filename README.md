...
autodot/0.1.7 darwin-x64 node-v9.11.1
...
_See code: [src/commands/bootstrap.ts](https://github.com/ajmalsiddiqui/autodot/blob/v0.1.7/src/commands/bootstrap.ts)_
...
_See code: [src/commands/init.ts](https://github.com/ajmalsiddiqui/autodot/blob/v0.1.7/src/commands/init.ts)_
...
_See code: [src/commands/install.ts](https://github.com/ajmalsiddiqui/autodot/blob/v0.1.7/src/commands/install.ts)_
...
_See code: [src/commands/run.ts](https://github.com/ajmalsiddiqui/autodot/blob/v0.1.7/src/commands/run.ts)_
...
_See code: [src/commands/sync.ts](https://github.com/ajmalsiddiqui/autodot/blob/v0.1.7/src/commands/sync.ts)_
<!-- commandsstop -->
